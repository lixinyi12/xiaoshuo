...
const FollowFan = () => {
    ...
    const [fanList, setFanList] = useState<User[]>([]);
    const [followStatus, setFollowStatus] = useState<Record<number, boolean>>({})
    const [fanStatus, setFanStatus] = useState<Record<number, boolean>>({})
    ...
    useEffect(() => {
        ...
        followList.forEach((follow: User) => {
                        ...
                        <div className="card-body p-0">
                            <div className={`tab-content ${styles.tabContent}`} id="myTabContent">
                                ...
                                <div className="tab-pane fade show active" id="followers" role="tabpanel">
                                    ...
                                    {totalFanPages > 1 && (
                                        <Pagination
                                            ...
                                            onChange={(page: any) => setCurrentFanPage(page)}
                                        />
                                    )}
                                </div>
                                ...
                                <div className="tab-pane fade" id="following" role="tabpanel">
                                    <div className="list-group list-group-flush">
                                        {paginatedFollows.map((follow: any, index: any) => (
                                            <div className={`list-group-item py-3 ${styles.listGroupItem}`} key={index}>
                                                <div className={styles.listGroupItemContent}>
                                                    <div className={`d-flex align-items-center ${styles.userInfo}`}>
                                                        <img
                                    ...
                                    {totalFollowPages > 1 && (
                                        <Pagination
                                            ...
                                            onChange={(page: any) => setCurrentFollowPage(page)}
                                        />
                                    )}
                                </div>
                            </div>
